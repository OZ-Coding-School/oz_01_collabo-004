...
urlpatterns = [
    ...
    path("mycoupon/used", views.UsedUserCouponListView.as_view(), name="used-user-coupons"),
    path("mycoupon/available", views.AvailableUserCouponListView.as_view(), name="available-user-coupons"),
    path(
        "mycoupon/<int:user_coupon_id>",
        views.UserCouponDetailView.as_view(),
        name="user-coupon-detail",
    ),
    path("issue/<int:coupon_id>", views.UserCouponIssueView.as_view(), name="user-coupon-issue"),
