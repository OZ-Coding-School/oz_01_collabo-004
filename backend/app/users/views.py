...
class JWTLoginView(TokenObtainPairView):
    def post(self, request):
        ...
        response.set_cookie('AUT_REF', refresh_token, samesite=None, secure=False, httponly=False, expires=datetime.now() + timedelta(days=1))
...
class JWTRefreshView(APIView):
    def post(self, request):
        ...
        try:
            ...
            return Response({"msg": "invalid refresh token. try login again"}, status=status.HTTP_400_BAD_REQUEST)
